...
import { Flame, PlusCircle, CheckCircle, Info, Trash2, Users, Building2 } from 'lucide-react';
...
const initialTips: SafetyTip[] = [
  {
    id: '1',
    title: 'Nationwide Home Fire Safety',
    category: 'Home Safety',
    audience: 'Public',
    description: 'Ensure every home has working smoke alarms, clear escape routes, and a practiced evacuation plan.',
  },
  {
    id: '2',
    title: 'Market Fire Prevention',
    category: 'Market / Shops',
    audience: 'Market Traders',
    description: 'Avoid illegal connections, do not overload sockets, and keep aisles free of combustible goods.',
  },
];
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              <h2 className="text-xl font-semibold text-gray-900 flex items-center gap-2">
                ...
                New National Safety Tip
              </h2>
              <p className="text-sm text-gray-600">
                Define standardised tips that stations can reuse in their outreach.
              </p>
            </div>
          </div>
          <form onSubmit={handleAddTip} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="e.g. Safe Use of LPG at Home"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Describe the safety tip in simple language suitable for national campaigns (max 200 words)."
              />
            ...
            <div className="flex items-center justify-between mt-2">
              <div className="flex items-center gap-2 text-xs text-gray-500">
                ...
                <span>Tips are stored locally for now; hook to API later for system-wide distribution.</span>
              </div>
              <button
                type="submit"
                disabled={isSaving}
        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 flex flex-col">
          ...
          {tips.length === 0 ? (
            <div className="flex-1 flex flex-col items-center justify-center text-center text-gray-500 py-8">
              ...
              <p className="text-sm mt-1">Use the form on the left to create tips for stations.</p>
            </div>
          ) : (
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <div className="mt-1 flex flex-wrap gap-2 text-xs">
                        <span className="px-2 py-0.5 rounded-full bg-red-50 text-red-700 border border-red-100 flex items-center gap-1">
                          <Building2 className="w-3 h-3" />
                          {tip.category}
                        </span>
                        <span className="px-2 py-0.5 rounded-full bg-blue-50 text-blue-700 border border-blue-100 flex items-center gap-1">

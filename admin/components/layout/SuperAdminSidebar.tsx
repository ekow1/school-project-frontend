...
const SuperAdminSidebar: React.FC = () => {
  ...
  const menuItems: SidebarItem[] = [
    ...
    { name: 'Stations', href: '/dashboard/superadmin/stations', icon: Building2 },
    { name: 'Civilians', href: '/dashboard/superadmin/users/civilian', icon: UserCircle },
    { name: 'Officers', href: '/dashboard/superadmin/users/fire-personnel', icon: UserCheck },
    { name: 'Station Admins', href: '/dashboard/superadmin/users/station-admins', icon: UserCog },
    { name: 'Ranks', href: '/dashboard/superadmin/users/ranks', icon: Badge },
    { name: 'Roles', href: '/dashboard/superadmin/users/roles', icon: Award },
    { name: 'Departments', href: '/dashboard/superadmin/departments', icon: Building2 },
    { name: 'Units', href: '/dashboard/superadmin/units', icon: Shield },
    ...
    { name: 'Fire Safety Tips', href: '/dashboard/superadmin/fire-safety', icon: Flame },
